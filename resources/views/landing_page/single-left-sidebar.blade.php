                     ...
                     <div class="col-lg-6">
                        <div class="page-content">
                           ...
                           <div class="blog-content">
                              ...
                              <a>
                                 <p>Far curiosity incommode now led smallness allowance. Favour bed assure son things yet. ipsum dolor sit amet, diam tibique mentitum sea in, minim alienum ei usu, duo ut doctus pericula. Fugit elitr contentiones id vix, his ex natum audiam.</p>
                              </a>
               ...
               <div class="post-comments m-30px-tb">
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <ul class="comment-list m-30px-b">
                              ...
                              <div class="the-comment">
                                 ...
                                 <div class="comment-box">
                                    <div class="comment-author meta">
                                       <strong>Mahmud</strong> September 2, 2022 at 1:38 pm<a rel="nofollow" class="comment-reply-link" href="#"> - Reply</a>
                                    </div>
                              ...
                              <ul class="children">
                                 <li class="comment">
                                    <div class="the-comment">
                                       ...
                                       <div class="comment-box">
                                          <div class="comment-author meta">
                                             <strong>Purnima</strong> June 2, 2022 at 1:39 pm<a rel="nofollow" class="comment-reply-link" href="#"> - Reply</a>
                                          </div>
                                          <div class="comment-text">
                           ...
                           <li class="comment">
                              <div class="the-comment">
                                 ...
                                 <div class="comment-box">
                                    <div class="comment-author meta">
                                       <strong>Mashrafee</strong> August 2, 2019 at 1:38 pm<a rel="nofollow" class="comment-reply-link" href="#"> - Reply</a>
                                    </div>
                                    <div class="comment-text">
                              ...
                              <ul class="children">
                                 <li class="comment">
                                    <div class="the-comment">
                                       ...
                                       <div class="comment-box">
                                          <div class="comment-author meta">
                                             <strong>Ayaraa</strong> August 2, 2019 at 1:39 pm<a rel="nofollow" class="comment-reply-link" href="#"> - Reply</a>
                                          </div>
                                          <div class="comment-text">
                        ...
                        <p class="m-30px-b">For commenting on this post fill the form and press <i>post comment</i> button. Required fields are marked *</p>
                        <div class="card card-info">
                           <div class="card-block">
                              <form action="#">
                                 ...
                                 <button class="btn btn-default animated-btn btn-filled" type="button">Post Comment</button>
                              </form>
                           </div>
                        </div>
                     </div>
