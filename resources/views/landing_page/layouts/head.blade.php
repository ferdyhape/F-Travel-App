...
<!---IcoFont Icon font-->
<link rel="stylesheet" href="{{ asset('landing_page/css/icofont.min.css') }}">
<!-- Bootsrap CSS -->
<link rel="stylesheet" href="{{ asset('landing_page/css/bootstrap.min.css') }}">
<!-- Animate CSS -->
<link href="{{ asset('landing_page/css/animate.min.css') }}" rel="stylesheet">
<!-- Swiper CSS -->
<link rel="stylesheet" href="{{ asset('landing_page/css/swiper.min.css') }}">
<!-- Theme Style -->
<link rel="stylesheet" href="{{ asset('landing_page/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('landing_page/css/gredients/purple.css') }}"> <!-- Default color version -->
<link rel="stylesheet" href="{{ asset('landing_page/css/typography/poppins-quciksland.css') }}">



<!-- Default typography version -->
