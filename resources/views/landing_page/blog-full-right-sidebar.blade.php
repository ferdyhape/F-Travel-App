...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="css/gredients/purple.css" id="color-switch"> <!-- Default color version -->
      <link rel="stylesheet" href="css/typography/poppins-quciksland.css" id="font-switch"> <!-- Default typography version -->
  ...
  <div class="demo-style-switch" id="switch-style">
     ...
     <div class="switched-options">
        ...
        <ul class="styles">
           <li>
              <div class="black gredient" id="black"></div>
           </li>
           <li>
              <div class="blue gredient" id="blue"></div>
           </li>
           <li>
              <div class="granduer gredient" id="granduer"></div>
           </li>
           <li>
              <div class="purple gredient" id="purple"></div>
           </li>
           <li>
              <div class="red gredient" id="red"></div>
           </li>
           <li>
              <div class="yellow gredient" id="yellow"></div>
           </li>
        </ul>
        <div class="config-title">
           SVG BG :
        ...
        <ul class="styles">
           <li>
              <div class="circles svg" id="circle"></div>
           </li>
           <li>
              <div class="circle-2 svg" id="circle-2"></div>
           </li>
           <li>
              <div class="hexagon svg" id="hexagon"></div>
           </li>
           <li>
              <div class="hexagon-2 svg" id="hexagon-2"></div>
           </li>
           <li>
              <div class="stripe svg" id="stripe"></div>
           </li>
           <li>
              <div class="stripe-2 svg" id="stripe-2"></div>
           </li>
        </ul>
        <div class="config-title">
           Flat BG :
        ...
        <select id="chose-typography">
           <option value="poppins-quciksland">Poppins + Quciksland</option>
           <option value="josefin-ptserif">Josefin + PtSerif</option>
           <option value="montsarat-opensans">Montsarat + OpenSans</option>
           <option value="ubuntu-sourcesanse">Ubuntu + SourceSanse</option>
           <option value="varela-roboto">Varela + Roboto</option>
        </select>
     </div>
  </div>
  </body>
